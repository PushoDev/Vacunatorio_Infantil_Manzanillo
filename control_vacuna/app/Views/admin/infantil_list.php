...
<head>
	...
	<title>Lista Infantiles | Admon</title>
	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i style="color: orange;" class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE NIÑOS EN  EL SISTEMA
				</h3>
				<p class="text-justify">
					Listado de los niños que han sido vacunados con el programa de Esquema de Vacunación, pertenecientes a nuestra localidad... 
				</p>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a class="active" href="<?php echo base_url('/infantil_list'); ?>"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTADO DE NIÑOS</a>
					</li>
					<li>
						<a href="<?php echo base_url('/infantil_search'); ?>"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR NIÑO</a>
					</li>
					...
					<table class="table table-dark table-sm">
						...
						<tbody>
							...
							<tr class="text-center" >
								<td><?php echo $key-> id_infante  ?></td>
								<td><?php echo $key-> c_identidad  ?></td>
								<td><?php echo $key-> nombre  ?></td>
								<td><?php echo $key-> dir_particular  ?></td>
								<td><?php echo $key-> cmf  ?></td>
								<td>
									<!-- Funcion de actualizar -->
									<a href="<?php echo base_url('/infantil_update/'.$key -> id_infante) ?>" class="btn btn-success">
	  									<i class="fas fa-sync-alt"></i>	
									</a>
								</td>
								<td>
									<!-- Funcio eliminar registro infantil -->
									<a href="<?php echo base_url('/infantil_delete/'.$key -> id_infante) ?>" class="btn btn-warning">
