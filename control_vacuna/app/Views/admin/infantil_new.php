	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR NIÑO
				</h3>
				<p class="text-justify">
					En este formulario se agregan los Niños los cuales pertenecen al área de estudio o aquellos que han sido vacunados en el área...
				</p>
			</div>

			<!-- Parte de las opciones infantiles -->
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a class="active" href="<?php echo base_url('/infantil_new'); ?>"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR NIÑO</a>
					</li>
					<li>
						<a href="<?php echo base_url('/infantil_list'); ?>"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE NIÑOS</a>
					</li>
			...
			<div class="container-fluid">
				...
				<form action="<?php echo base_url('/nuevo_infante') ?>" method="post" class="form-neon" autocomplete="off">
					<fieldset>
						<legend><i class="fas fa-user"></i> &nbsp; Información básica de registro</legend>
						<div class="container-fluid">
							<div class="row">
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="c_identidad" class="bmd-label-floating">Carnet de Identidad</label>
										<input type="text" class="form-control" name="c_identidad" id="c_identidad" maxlength="11">
									</div>
								</div>
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="nombre" id="nombre" maxlength="40">
									</div>
								</div>
								...
								<div class="col-12 col-md-4">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="edad" id="edad" maxlength="40">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="cmf" class="bmd-label-floating">CMF_Consultorio Médico de la Familia</label>
										<input type="text" class="form-control" name="cmf" id="cmf" maxlength="3">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="dir_particular" class="bmd-label-floating">Dirección de Residencia</label>
										<input type="text" class="form-control" name="dir_particular" id="dir_particular" maxlength="150">
									</div>
								</div>
							</div>
						</div>
